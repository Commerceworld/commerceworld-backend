...
async function initDb() {
  ...
  /* Reader accounts (separate from the single site "admin" login above).
     Lets each reader log in and have their saved articles / reading
     history follow them across devices and browser refreshes. */
  await pool.query(`
  ...
  if (configRes.rows.length === 0) {
    await pool.query(
      ...
      [
        ...
        JSON.stringify([
          { id: 'LATEST', name: 'Latest', parent: null },
          { id: 'TREND', name: 'Trend', parent: null },
          { id: 'TRADE', name: 'Trade', parent: null },
          { id: 'TECH', name: 'Tech', parent: null },
          { id: 'CURRENCY', name: 'Currency', parent: null },
          { id: 'STARTUPS', name: 'Startups', parent: null },
          { id: 'WEB3', name: 'Web3', parent: null },
        ]),
      ]
    );
  }
